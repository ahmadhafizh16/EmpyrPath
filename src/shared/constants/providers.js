...
export const FREE_TIER_PROVIDERS = {
	routeway: {
		...
		notice: {
			text: "OpenAI-compatible API with free-tier models tagged :free.",
...
export const OAUTH_PROVIDERS = {
	...
	codebuddy: {
		...
		notice: { signupUrl: "https://codebuddy.ai" },
	},
...
export const APIKEY_PROVIDERS = {
	...
	morph: {
		...
		notice: { apiKeyUrl: "https://morphllm.com/dashboard/api-keys" },
		serviceKinds: ["llm", "embedding"],
		embeddingConfig: {
			baseUrl: "https://api.morphllm.com/v1/embeddings",
			authType: "apikey",
			authHeader: "bearer",
			models: [
				{
					id: "morph-embedding-v4",
	...
	qiniu: {
		...
		color: "#3B82F6",
		textIcon: "QN",
		notice: { apiKeyUrl: "https://portal.qiniu.com" },
		serviceKinds: ["llm"],
	},
	swiftrouter: {
		id: "swiftrouter",
		...
		color: "#0EA5E9",
		textIcon: "SR",
		website: "https://swiftrouter.com",
		notice: {
			text: "OpenAI-compatible API with curated recent and popular models. The /models endpoint requires an API key.",
			apiKeyUrl: "https://swiftrouter.com",
		},
		serviceKinds: ["llm"],
		modelsFetcher: {
	...
	canopywave: {
		...
		notice: {
			text: "Free-tier OpenAI-compatible inference endpoint. Supports MiMo and Kimi models.",
			apiKeyUrl: "https://canopywave.io",
		},
		serviceKinds: ["llm"],
	},
	glm: {
