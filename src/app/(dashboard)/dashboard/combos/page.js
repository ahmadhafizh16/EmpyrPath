...
export default function CombosPage() {
	...
	return (
		<div
			...
			className="flex min-w-0 flex-col gap-6 px-1 sm:px-0"
		>
			<PageHero
				section={S.color}
				eyebrow={S.eyebrow}
			...
			{combos.length === 0 ? (
				<Card>
					<div className="text-center py-12">
						...
						<p className="text-ink font-semibold tracking-tight mb-1">
							No combos yet
						</p>
						<p className="text-sm text-steel mb-5">
							Stack models with weighted fallback and round-robin.
						</p>
						<Button
							icon="add"
							onClick={() => setShowCreateModal(true)}
